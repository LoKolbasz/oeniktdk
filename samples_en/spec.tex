...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,height=100px]{oe_logo}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,height=100px,frame]{oe_logo}
	\caption{Quisque ac tincidunt leo}
\end{figure}
...
\begin{figure}[H]
	...
	\subcaptionbox{Vestibulum quis mattis urna}{
		\includegraphics[width=0.45\linewidth]{oe_logo}}
	\hspace{5pt}
