...
\degree{Mérnökinformatikus MSc}
\period{2. évfolyam}
\coauthor{Hallgató Harold}
\codegree{Mérnökinformatikus BSc}
\coperiod{3. évfolyam}
...
\faculty{Neumann János Informatikai Kar}
\department{Insert Intézet here}
\city{Budapest}
\logo{oe_logo.png}

% Add bibliography file
\addbibresource{oeniktdk.bib}
